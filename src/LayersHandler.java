...
//---------------------------------------------------------------------------------
	...
	public void addNewTerminal (Point2D globalPoint2D, String terminalName)
	{
		...
		else System.out.println("El terminal: " + terminalName + " ya existe");
	}
...
//-------------------------------------------------------------------------------------------	
	public void addConnection (NKNode node1, NKNode node2)
	{
		...
		else edge = new NKConection(node1,node2);
...
*/
	...
	/*************************************************************
	 * Los terminales s�o se conectan a trav� de una interfaz,
	 * en caso de que ya estuviera conectado, se borra su antiga
	 * conexi� y se a�de la nueva
	 *************************************************************/	
