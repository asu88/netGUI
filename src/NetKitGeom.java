...
public class NetKitGeom {
    ...
    public static Point2D getGlobalIntersect(RectangleNodeDelimiter r,
            NKNode nodoOrigen, NKConection line) // ecuation rect: y = ax+b (b=0); a = d1/d2
    {
    ...
    /**
     * *********************************************************
     * El punto de intersecci�n con la recta y = mx +b 
	 **********************************************************
     */
    ...
    /**
     * *********************************************************
     * El punto de intersecci�n con la recta y = mx +b que pasa el origen de
     * coordenadas
	 **********************************************************
     */
    ...
    private static Point2D checkLimits(double m, Point2D origen, Point2D fin,
        ...
        //el fin est� dentro del rect�ngilo definido para el icono
