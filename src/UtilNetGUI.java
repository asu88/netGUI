...
{	
	 ...
	 * (nuevo proyecto, cargar proyecto...)
	 ****************************************/
	...
	/*********************************************
	 * Devuelve true si el archivo fileName existe
	...
	/*********************************************
	 * Si existe el fichero .disk asociado al nodo
	 * lo borra y devuelve true
	 *********************************************/
	...
	/****************************************
	 * Método de clase que devuelve un nombre
	 * para una nueva red
	 ****************************************/
	...
	public static boolean aplicationChanged () {return statusChanged;}
	public static void setAplicationStatusChange (boolean change)
		{
			statusChanged = change;
		}
		
	public static void IncrementHubCount () {hubCount++;}
	public static void IncrementRouterCount () {routerCount++;}
	public static void IncrementSwitchCount () {switchCount++;}
	public static void IncrementPcCount () {systemCount++;}
	public static void IncrementNetCount () {netCount++;}
